...
While we avoid the use of tensors in most of this study, there is a notable exception to be made for the Euclidean transformation group $E(2)$. In this setting we can restrict ourselves to \emph{Cartesian tensors}, where we need make no distinction between covariance and contravariance, they are both the same thing. We use subscript indices exclusively, for this reason. 
...
\todo[inline]{Introduce image that we are going to use in subsequenct examples}
