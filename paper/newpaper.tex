...
\begin{equation}
\left( \begin{array}f_x \\ f_y \end{array} \right) = \left( \begin{array} \cos \theta & \sin \theta \\ - \sin \theta & \cos \theta \end{array} \right) \left( \begin{array} \bar f_{\bar x} \\ \bar f_{\bar y} \end{array} \right).
\end{equation}
