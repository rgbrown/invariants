...
The setting that we will consider is a transformation group $\mathcal{G}$ acting on a manifold $\mathcal{M}$ of dimension $n$. A $d$-th order differential invariant is a local scalar function $I: J^{d} (\mathbb{R}, \mathcal{M} ) \to \mathbb{R}$ that is invariant under the action of $\mathcal{G}$, i.e., $I(g(x,u^{(d)})) = I(x, u^{(d)}) \forall g \in \mathcal{G}$, where $J^{d}$ denotes the $d$-th order jet space.
...
Is this helpful? 
\todo[inline]{Yes, this is helpful but not quite correct yet - $SE(2)$ is missing, and we need edges from $\text{Diff}_{\text{vol}}$ to the special affine and Euclidean groups}
\todo[inline]{Other notes: should our projective group be $PGL(3, \mathbb{R})$ rather than $PSL(3, \mathbb{R})$? or am I confused?}
\begin{figure}
\begin{center}
...
\node(A1) [below right of=C3]                          {$PSL(2,\mathbb{C})$};
\node(B1)    [below of=C2]    {$PSL(3,\mathbb{R})$};
\node(B2)   [below of=B1]              {$A(2)$};
\node(A2)       [below left of=A1]          {Sim$(2)$};
\node(A3)      [right of=A2]              {$PSL(2,\mathbb{R})$};
\node(B3)   [below of=B2]            {$SA(2)$};
\node(A4)      [below of=A2]            {$E(2)$};
\node(A5) [below right of=A4]{Translation};
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{Figs/SE2Transform_transform.png}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{Figs/E2Transform_transform.png}
\includegraphics[width=.45\textwidth]{Figs/E2Transform_signature.png}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{Figs/SA2Transform_transform.png}
\includegraphics[width=.45\textwidth]{Figs/SA2Transform_signature.png}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{Figs/A2Transform_transform.png}
\includegraphics[width=.45\textwidth]{Figs/A2Transform_signature.png}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{Figs/MobiusTransform_transform.png}
\includegraphics[width=.45\textwidth]{Figs/MobiusTransform_signature.png}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{Figs/PSL3RTransform_transform.png}
\includegraphics[width=.45\textwidth]{Figs/PSL3RTransform_signature.png}
