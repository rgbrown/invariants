...
When introduce each group, mention relevance to images?

Friendly intro to moving frame
Finish colour
...
The most basic transformation group of a image is the translation group $T(2): \phi(\mathbf{x}) = \mathbf{x} + \mathbf{t}$.
...
The concept of a relative invariant will be important in what follows. 
...
We will subject our image to a special affine transformation:
\begin{equation*}
...
** Given the importance of the conformal camera model ...
