...
sigfun = @SA2sig;
%% Generate a random equiaffine mapping
% Or in this case, load one from file, just contains A, b and Ainv, binv
% for the forward and backward transformations
load SA2tform.mat

%% Perform forward mapping
% By remapping coordinates
...
surf(sig1{2}, sig1{3}, sig1{1}, sig1{1}, 'edgecolor', 'none', 'facealpha', 1)
colormap(cm)
shading('interp')
camlight()
axis off
